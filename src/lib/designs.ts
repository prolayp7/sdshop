...
export const DESIGNS: DesignMeta[] = [
  {
    ...
    slug: "bytevex",
    name: "Bytevex",
    tagline: "Performance memory cards, format-first shopping",
    extendedPagesRolledOut: true,
    fontHref: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Manrope:wght@700;800&display=swap",
  },
  {
    id: "01",
    slug: "highstreet",
...
export const HIGHSTREET_DESIGN: DesignMeta = DESIGNS[1];
