...
import Home from "@/designs/bytevex/Home";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    title: { absolute: settings.metaTitle || "BYTEVEX | Performance Memory Cards" },
    description: settings.metaDescription || "Explore SD, microSD and CFexpress cards by format, capacity and speed class.",
    openGraph: {
