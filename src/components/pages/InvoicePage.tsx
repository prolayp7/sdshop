  ...
  return layout(
    <div style={{ maxWidth: 900, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", margin: "8px 0 16px" }}>
        ...
        <button type="button" onClick={() => void download()} disabled={downloading} style={{ background: "#087ff5", color: "#fff", padding: "10px 18px", borderRadius: 8, fontWeight: 700, opacity: downloading ? 0.7 : 1 }}>
